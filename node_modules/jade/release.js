...
// : check that the version is a new un-released version
// : check the user has commit access to the github repo
// : check the user is an owner in npm
// : check History.md has been updated
...
getToken(function (token) {
  compiledWebsite.then(function () {
    ...
    // : release the new npm package, set the tag and commit etc.
  }).done();
});
